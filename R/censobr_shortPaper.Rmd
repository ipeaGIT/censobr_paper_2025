---
title: '`{censobr}`: Easy Access to Brazilian Demographic Censuses'
author:
...
temp1
```
For privacy concerns, IBGE does not distribute microdata from the universe survey. Its information is released instead as data aggregated into census tracts. These are summary statististics (counts, proportions, and means) computed by IBGE from the short form questionnaire. The aggregated data from the universe allows then for analyses at very precise geographic levels, but prohibiting individual- and household-level analysis.
...
The package includes several core functions to download and read different types of census data, as well as auxiliary functionalities:
...
|----------------------|----------------------|--------------------------------------------------------|
| `data_dictionary()`  | Variable dictionary  | Microdata:                                             |
|                      |                      | 1960, 1970, 1980, 1991, 2000, 2010 (2022: coming soon) |
|                      |                      |                                                        |
|                      |                      | Aggregates:                                            |
|                      |                      | 2000, 2010 (coming soon for 2022)                      |
|                      |                      |                                                        |
...
##### 7.4.1. Spatial Distribution of Income in 2010
...
##### 7.4.2. Spatial Distribution of Population in 2022
